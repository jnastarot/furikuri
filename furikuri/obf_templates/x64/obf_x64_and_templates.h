...
bool _and_64_reg_reg_tmpl(mutation_context& ctx) {
...
bool _and_64_reg_imm_tmpl(mutation_context& ctx) {
...
bool _and_64_reg_op_tmpl(mutation_context& ctx) {
...
bool _and_64_op_reg_tmpl(mutation_context& ctx) {
...
bool _and_64_op_imm_tmpl(mutation_context& ctx) {
