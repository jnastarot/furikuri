...
bool _btr_64_reg_reg_tmpl(mutation_context& ctx) {
...
bool _btr_64_reg_imm_tmpl(mutation_context& ctx) {
...
bool _btr_64_op_reg_tmpl(mutation_context& ctx) {
...
bool _btr_64_op_imm_tmpl(mutation_context& ctx) {
