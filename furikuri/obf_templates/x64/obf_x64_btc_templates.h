...
bool _btc_64_reg_reg_tmpl(mutation_context& ctx) {
...
bool _btc_64_reg_imm_tmpl(mutation_context& ctx) {
...
bool _btc_64_op_reg_tmpl(mutation_context& ctx) {
...
bool _btc_64_op_imm_tmpl(mutation_context& ctx) {
...
bool fukutate_64_btc(mutation_context& ctx) {
