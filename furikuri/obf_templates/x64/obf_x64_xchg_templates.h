...
//xor dst_2, dst_1
//xor dst_1, dst_2
inline bool _xchg_64_multi_tmpl_1(mutation_context& ctx, fuku_type dst_1, fuku_type dst_2, int8_t inst_size) {
...
inline bool _xchg_64_multi_tmpl_2(mutation_context& ctx, fuku_type dst_1, fuku_type dst_2, int8_t inst_size) {
    ...
    if (!get_operand_dst_x64( temp_dst_1, INST_ALLOW_REGISTER, inst_size, out_regflags,
    ...
    if (!get_operand_dst_x64( temp_dst_2, INST_ALLOW_REGISTER, inst_size, out_regflags,
        FLAG_REGISTER_SP | FLAG_REGISTER_ESP)) {
...
bool _xchg_64_reg_reg_tmpl(mutation_context& ctx) {
    ...
    case 0: {
        return _xchg_64_multi_tmpl_1(ctx, reg_dst_1, reg_dst_2, detail.operands[0].size);
    }
    case 1: {
        return _xchg_64_multi_tmpl_2(ctx, reg_dst_1, reg_dst_2, detail.operands[0].size);
    }
...
bool _xchg_64_op_reg_tmpl(mutation_context& ctx) {
    ...
    case 0: {
        return _xchg_64_multi_tmpl_2(ctx, op_dst, reg_dst, detail.operands[0].size);
    }
    default: { return false; }
    }
...
bool fukutate_64_xchg(mutation_context& ctx) {
    auto detail = ctx.instruction->detail->x86;
