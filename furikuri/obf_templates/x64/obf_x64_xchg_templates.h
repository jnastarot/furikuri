...
inline bool _xchg_64_multi_tmpl_2(mutation_context& ctx, fuku_type dst_1, fuku_type dst_2, int8_t inst_size) {
    ...
    if (!generate_64_operand_dst(ctx, temp_dst_1, INST_ALLOW_REGISTER, inst_size, out_regflags,
    ...
    if (!generate_64_operand_dst(ctx, temp_dst_2, INST_ALLOW_REGISTER, inst_size, out_regflags,
        FLAG_REGISTER_SP | FLAG_REGISTER_ESP)) {
