...
bool _rcr_64_reg_reg_tmpl(mutation_context& ctx) {
...
bool _rcr_64_reg_imm_tmpl(mutation_context& ctx) {
...
bool _rcr_64_op_reg_tmpl(mutation_context& ctx) {
...
bool _rcr_64_op_imm_tmpl(mutation_context& ctx) {
...
bool fukutate_64_rcr(mutation_context& ctx) {
