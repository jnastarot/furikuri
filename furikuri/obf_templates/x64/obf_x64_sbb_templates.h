...
bool _sbb_64_reg_reg_tmpl(mutation_context& ctx) {
...
bool _sbb_64_reg_imm_tmpl(mutation_context& ctx) {
...
bool _sbb_64_reg_op_tmpl(mutation_context& ctx) {
...
bool _sbb_64_op_reg_tmpl(mutation_context& ctx) {
...
bool _sbb_64_op_imm_tmpl(mutation_context& ctx) {
...
bool fukutate_64_sbb(mutation_context& ctx) {
