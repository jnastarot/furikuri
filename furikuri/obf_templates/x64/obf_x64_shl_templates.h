...
bool _shl_64_reg_reg_tmpl(mutation_context& ctx) {
...
bool _shl_64_reg_imm_tmpl(mutation_context& ctx) {
...
bool _shl_64_op_reg_tmpl(mutation_context& ctx) {
...
bool _shl_64_op_imm_tmpl(mutation_context& ctx) {
...
bool fukutate_64_shl(mutation_context& ctx) {
