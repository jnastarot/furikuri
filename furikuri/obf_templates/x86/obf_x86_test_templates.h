...
bool _test_86_reg_reg_tmpl(mutation_context& ctx) {
...
bool _test_86_reg_imm_tmpl(mutation_context& ctx) {
...
bool _test_86_op_reg_tmpl(mutation_context& ctx) {
...
bool _test_86_op_imm_tmpl(mutation_context& ctx) {
