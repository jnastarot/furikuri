...
bool junk_64_low_pattern_1(mutation_context & ctx) {
    ...
    fuku_register reg1_ = get_random_free_flag_reg(ctx.regs_changes, reg_size, true, FLAG_REGISTER_SP | FLAG_REGISTER_ESP | FLAG_REGISTER_RSP);
    ...
    case 1: {//todo
        fuku_register reg1_ = get_random_free_flag_reg(ctx.regs_changes, 1, true, FLAG_REGISTER_SP | FLAG_REGISTER_ESP | FLAG_REGISTER_RSP);
    ...
    case 3: {
        fuku_register reg2_ = get_random_free_flag_reg(ctx.regs_changes, reg_size, true, FLAG_REGISTER_SP | FLAG_REGISTER_ESP | FLAG_REGISTER_RSP);
    ...
    case 4: {
        reg1_ = get_random_free_flag_reg(ctx.regs_changes, reg_sizes_64[FUKU_GET_RAND(1, 2)], true, FLAG_REGISTER_SP | FLAG_REGISTER_ESP | FLAG_REGISTER_RSP);
        if (reg1_.get_reg() == FUKU_REG_NONE) {
            return false;
        }
...
//not reg1
//not reg1
bool junk_64_high_pattern_2(mutation_context & ctx) {

    uint32_t reg_size = reg_sizes_64[FUKU_GET_RAND(0, 3)];
    fuku_register reg1_ = get_random_reg(reg_size, true, FLAG_REGISTER_SP | FLAG_REGISTER_ESP | FLAG_REGISTER_RSP);
